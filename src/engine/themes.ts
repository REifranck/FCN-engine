...
export const GENRE_TEMPLATES: Record<Genre, GenreTemplate> = {
  ...
  horror: { id: "horror", label: "Terror", emoji: "🕯️", camera: "follow", physics: "adventure", controls: "move", tools: ["fog", "dirt", "height", "water", "mountain"] as TerrainBrush[], assets: ["Casas", "Florestas", "Criaturas", "Névoa", "Luzes", "Sons", "Portais", "Sombras"] },
